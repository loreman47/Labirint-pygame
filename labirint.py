...
mixer.music.load('sounds/ricroll.mp3') # фоновые звуки леса
...
img_file_back = 'images/sky.png'
hero_images_pistol = [transform.scale(image.load('images/spritedelbck.png'),(80,85)),
                    transform.scale(image.load('images/spritedelbck.png'),(80,85)),
                    transform.scale(image.load('images/spritedelbck.png'),(80,85))]
hero_images_shotgun = [transform.scale(image.load('images/cola.png'),(80,85)),
                    transform.scale(image.load('images/cola.png'),(80,85)),
                    transform.scale(image.load('images/cola.png'),(80,85))]
img_file_enemy = 'images/wall.png'
img_file_princess = 'images/portl.png'
img_bullet = 'images/coladelbg.png'
